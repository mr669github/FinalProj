        ...
        <nav class="navbar">
            <div class="search-box">
                ...
                <form id="searchForm" action="#" role="search">
                    <input type="search" placeholder="Looking For?" class="form-control">
                </form>
            </div>
         ...
         <span class="heading">Main</span>
            <div>
                <ul class="list-unstyled">
                    ...
                    <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>FINAL WSD PROJECT!</a>
